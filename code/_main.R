...
countysumm_wht  <- read_csv(glue("{cleandata}/countysumm_wht.csv")) # county X year-level stats (most analysis uses this)

statesumm   <- read_csv(glue("{cleandata}/statesumm.csv"))
link1       <- read_csv(glue("{cleandata}/link1_swt_indiv.csv"))
#link1state  <- read_csv(glue("{cleandata}/link1_swt_state.csv"))
link1point5 <- read_csv(glue("{cleandata}/link1point5_wtnc_indiv.csv"))
link2       <- read_csv(glue("{cleandata}/link2_mwnilf_indiv.csv"))
#link2state  <- read_csv(glue("{cleandata}/link2_swnilf_state.csv"))
link2point5 <- read_csv(glue("{cleandata}/link2point5_mwnt_indiv.csv"))
link3       <- read_csv(glue("{cleandata}/link3_swnilf_indiv.csv"))
#link3state  <- read_csv(glue("{cleandata}/link3_mwnilf_state.csv"))
link3point5 <- read_csv(glue("{cleandata}/link3point5_swnt_indiv.csv"))

link1sec       <- read_csv(glue("{cleandata}/link1_sws_indiv.csv"))
link2sec       <- read_csv(glue("{cleandata}/link2_mwns_indiv.csv"))
link3sec       <- read_csv(glue("{cleandata}/link3_swns_indiv.csv"))
